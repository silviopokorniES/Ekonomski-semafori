...
- Trend-method comparison (docs/trend_method_comparison.md): the two-sided HP stays; last 12 months flagged provisional in the methodology.
- Tier 2 indicators added for every country: real gross value added and capacity utilisation on the main clock; the house price index and loans to non-financial corporations on a new financial panel. Lagging series carry the panel label confirmation. HICP is not added (a price level is not a cycle quantity).
