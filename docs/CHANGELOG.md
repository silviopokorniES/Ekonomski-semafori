...
- X-13 models (transformation and ARIMA orders) are identified once per series and step and frozen in config/x13_models.yaml; the monthly run re-estimates parameters with the model fixed. Re-identification at the annual review.
